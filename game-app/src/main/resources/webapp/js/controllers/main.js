gameApp
    ...
    .controller('portalAdminCtrl', function ($scope, $timeout, $state, growlService) {
        //Welcome Message
    ...
    // =========================================================================
    .controller('sidebarLeftController', function ($scope, $rootScope, $http, $timeout, $log) {
        ...
        var getMainMenu = function () {
            var url = GAME_URL_TOPOLOGY + "/sidebar-left/map";
            getJson($scope, $log, $http, $timeout, url,
                function (data, status) {
                    ...
                    $log.info("Get sidebar left menu: ", data, ", status: ", status);
                },
                function (data, status) {
                    $log.error("Failed to get sidebar left menu: ", data, ", status: ", status);
                }
            );
        }
